...
lazy val iuberdata_core = project settings (
  libraryDependencies ++= Seq(
      "com.amazonaws" % "aws-java-sdk" % "1.8.9.1" excludeAll ExclusionRule(organization = "com.fasterxml.jackson.core")
...
lazy val iuberdata_zeppelin = project dependsOn (iuberdata_core % "test->test;compile->compile") settings
  (libraryDependencies ++= Seq(
      ...
      , "org.apache.zeppelin" % "zeppelin-spark" % zeppelin_version % "provided" excludeAll  ExclusionRule(organization = "org.rosuda.REngine")
      , "org.apache.zeppelin" % "zeppelin-shell" % zeppelin_version  excludeAll ExclusionRule(organization = "org.mortbay.jetty") excludeAll ExclusionRule(organization = "org.slf4j")
      , "org.apache.spark" %% "spark-repl" % sparkVersion % "provided"
      , "org.apache.spark" %% "spark-sql" % sparkVersion % "provided"
      , "org.apache.spark" %% "spark-hive" % sparkVersion % "provided"
...
lazy val iuberdata_addon_zeppelin = project settings (
  libraryDependencies ++= Seq(
