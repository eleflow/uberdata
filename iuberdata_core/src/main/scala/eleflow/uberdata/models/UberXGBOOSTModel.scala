...
case class UberXGBOOSTModel(objective: String, booster: String, eta: Double, maxDepth: Int,
														subSample: Double, colSampleBTree: Double, minChildWeight: Int,
														gamma: Int, evalMetric: String, treeMethod: String, rounds: Int,
