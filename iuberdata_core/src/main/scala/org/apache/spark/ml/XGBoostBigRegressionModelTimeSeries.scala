...
//  */
//TODO: reativar esta classe
//class XGBoostBigRegressionModelTimeSeries[I](override val uid: String,
//                                             override val models: Seq[(ParamMap, XGBoostRegressionModel)])
//                                  extends XGBoostBigRegressionModel[I](uid, models) with HasTimeCol{
//
