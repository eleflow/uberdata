...
/**
 * Created by dirceu on 23/03/17.
 */
public class UberZeppelinContext {
    ...
    static {
        ...
        interpreterClassMap.put("uberdata", "org.apache.zeppelin.spark.IUberSparkInterpreter");
        interpreterClassMap.put("sql", "org.apache.zeppelin.spark.IUberdataSparkSqlInterpreter");
    ...
    public UberZeppelinContext(IUberdataContext uc,
    ...
    public void show(Object o, int maxResult) {
        try {
            if (supportedClasses.contains(o.getClass())) {
                interpreterContext.out.write(showDF(uc.sparkContext(), interpreterContext, o, maxResult));
            } else {
    ...
    public static String showDF(UberZeppelinContext z, Object df) {
        return showDF(z.uc.sparkContext(), z.interpreterContext, df, z.maxResult);
    }
    ...
    public void setEventClient(RemoteEventClientWrapper eventClient) {
        if (UberZeppelinContext.eventClient == null) {
            UberZeppelinContext.eventClient = eventClient;
        }
    }
