...
public class SparkSqlInterpreterTest {
	...
	private IUberdataSparkSqlInterpreter sql;
  private IUberSparkInterpreter repl;
  ...
  private InterpreterGroup intpGroup;
	...
	public void setUp() throws Exception {
		...
		if (repl == null) {
		  ...
		  if (IUberSparkInterpreterTest.repl == null) {
		    repl = new IUberSparkInterpreter(p);
		    repl.open();
		    IUberSparkInterpreterTest.repl = repl;
		  } else {
		    repl = IUberSparkInterpreterTest.repl;
		  }

  		sql = new IUberdataSparkSqlInterpreter(p);
